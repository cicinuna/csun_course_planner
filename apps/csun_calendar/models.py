...
class Schedule(models.Model):
    ...
    year_one_semester_one = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_one_semester_two = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_one_summer = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_two_semester_one = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_two_semester_two = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_two_summer = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_three_semester_one = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_three_semester_two = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_three_summer = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_four_semester_one = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_four_semester_two = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    year_four_summer = ArrayField(models.CharField(max_length = 255), blank = True, null = True)
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)

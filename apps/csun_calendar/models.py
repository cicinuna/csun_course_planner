...
class User(models.Model):
    ...
    major_elective_preference = ArrayField(ArrayField(models.CharField(max_length = 255), blank = True), null = True)
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)

class Schedule(models.Model):
    user_id = models.ForeignKey(User, related_name = "student")
    year_one_semester_one = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_one_semester_two = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_one_summer = ArrayField(ArrayField(models.CharField(max_length = 255), blank = True, default = None))
    year_two_semester_one = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_two_semester_two = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_two_summer = ArrayField(ArrayField(models.CharField(max_length = 255), blank = True, default = None))
    year_three_semester_one = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_three_semester_two = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_three_summer = ArrayField(ArrayField(models.CharField(max_length = 255), blank = True, default = None))
    year_four_semester_one = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_four_semester_two = ArrayField(ArrayField(models.CharField(max_length = 255)))
    year_four_summer = ArrayField(ArrayField(models.CharField(max_length = 255), blank = True, default = None))
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)
